...
def populate(num_rats,min_wt,max_wt,mode_wt):
    """Initialize population with traingular distribution of weights"""
...
def mutate(children,mutate_odds,mutate_min,mutate_max):
    ...
    return children
def main():
    """Initialize p[opulation,select,breed, and mutate, display results."""
    generations=0
    ...
    while popl_fitness<1 and generations<GENERATION_LIMIT:
        ...
        popl_fitness=fitness(parents,GOAL)
        print("Generation {} fintess = {:.4f}".format(generations,popl_fitness))
